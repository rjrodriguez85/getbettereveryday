	...
	public static function ajaxpage_spinner()
	{
		...
		<div class="ajax-page-load-indicator" style="display:none">
			<div class="text-center d-flex justify-content-center load-indicator">
				...
				<span class="font-weight-bold"><?php print_lang('loading_'); ?></span>
			</div>
		</div>
		<?php
	}
			...
			<div class="modal-dialog modal-dialog-centered modal-sm">
				<div class="modal-content">
					<div class="modal-header">
						<h4 class="modal-title"><?php print_lang('import_data'); ?></h4>
						<button type="button" class="close" data-dismiss="modal">&times;</button>
					</div>
					<div class="modal-body">
						<label><?php print_lang('select_a_file_to_import'); ?> <input required="required" class="form-control form-control-sm" type="file" name="file" /> </label>
						<small class="text-muted"><?php print_lang('supported_file_types'); ?>(csv , json)</small>

					</div>
					<div class="modal-footer">
						<button type="reset" class="btn btn-secondary" data-dismiss="modal"><?php print_lang('close'); ?></button>
						<button type="submit" class="btn btn-primary"><?php print_lang('import_data'); ?></button>
					</div>
				</div>
			</div>
		</form>
