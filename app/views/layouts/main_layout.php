			...
			<div id="main-content">
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title"><?php print_lang('delete_record'); ?></h5>
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-secondary" data-dismiss="modal"><?php print_lang('cancel'); ?></button>
								<a href="" id="delete-record-modal-btn" class="btn btn-primary"><?php print_lang('delete'); ?></a> 
							</div>
						</div>
					</div>
				</div>
				...
				<template id="page-loading-indicator">
					<div class="p-2 text-center m-2 text-muted m-auto">
						...
						<h4 class="p-3 mt-2 font-weight-light"><?php print_lang('loading_'); ?></h4>
					</div>
				</template>
				<template id="page-saving-indicator">
					<div class="p-2 text-center m-2 text-muted">
						<div class="lds-dual-ring"></div>
						<h4 class="p-3 mt-2 font-weight-light"><?php print_lang('saving_'); ?></h4>
					</div>
				</template>
